  ...
  >
    ...
    <g clipPath="url(#prefix__a)">
      ...
      >
        ...
        <stop offset="99.66%" stopColor="#cb00dd" />
        <stop offset="100%" stopColor="#cb00dd" />
      </linearGradient>
      <path
        fill="url(#prefix__b)"
        d="M165.72 260.48v379.04L450 829.04l284.28-189.52V260.48L450 70.96 165.72 260.48zm-3.57 381.42V258.1L450 66.2l287.85 191.9v383.8L450 833.8 162.15 641.9z"
    ...
    <g clipPath="url(#prefix__c)">
      <linearGradient
        ...
        y1={0.5}
        y2={0.5}
        gradientTransform="matrix(0 790.111 610.515 0 144.74 54.95)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0%" stopColor="#3ddeed" />
        <stop offset="99.66%" stopColor="#cb00dd" />
    ...
    <g clipPath="url(#prefix__e)">
      <linearGradient
        ...
        y1={0.5}
        y2={0.5}
        gradientTransform="matrix(0 811.054 645.202 0 127.4 44.47)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0%" stopColor="#3ddeed" />
        <stop offset="99.66%" stopColor="#cb00dd" />
    ...
    <g clipPath="url(#prefix__g)">
      <linearGradient
        ...
        y1={0.5}
        y2={0.5}
        gradientTransform="scale(679.626 830.247) rotate(90 .06 .1)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0%" stopColor="#3ddeed" />
        <stop offset="99.66%" stopColor="#cb00dd" />
    ...
    <g clipPath="url(#prefix__i)">
      <linearGradient
        ...
        y1={0.5}
        y2={0.5}
        gradientTransform="matrix(0 847.51 713.639 0 93.18 26.25)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0%" stopColor="#3ddeed" />
        <stop offset="99.66%" stopColor="#cb00dd" />
    ...
    <g clipPath="url(#prefix__k)">
      <linearGradient
        ...
        y1={0.5}
        y2={0.5}
        gradientTransform="matrix(0 862.664 747.089 0 76.46 18.67)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0%" stopColor="#3ddeed" />
        <stop offset="99.66%" stopColor="#cb00dd" />
    ...
    <g clipPath="url(#prefix__m)">
      <linearGradient
        ...
        y1={0.5}
        y2={0.5}
        gradientTransform="matrix(0 875.514 779.817 0 60.1 12.24)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0%" stopColor="#3ddeed" />
        <stop offset="99.66%" stopColor="#cb00dd" />
    ...
    <g clipPath="url(#prefix__o)">
      <linearGradient
        ...
        y1={0.5}
        y2={0.5}
        gradientTransform="matrix(0 885.871 811.65 0 44.17 7.07)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0%" stopColor="#3ddeed" />
        <stop offset="99.66%" stopColor="#cb00dd" />
    ...
    <g clipPath="url(#prefix__q)">
      <linearGradient
        ...
        y1={0.5}
        y2={0.5}
        gradientTransform="matrix(0 893.531 842.415 0 28.8 3.23)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0%" stopColor="#3ddeed" />
        <stop offset="99.66%" stopColor="#cb00dd" />
    ...
    <g>
      ...
      <g clipPath="url(#prefix__s)">
        <linearGradient
          ...
          y1={0.5}
          y2={0.5}
          gradientTransform="matrix(0 898.308 -871.927 0 0 0)"
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0%" stopColor="#3ddeed" />
          <stop offset="99.66%" stopColor="#cb00dd" />
    ...
    <g>
      ...
      <g clipPath="url(#prefix__u)">
        <linearGradient
          ...
          y1={0.5}
          y2={0.5}
          gradientTransform="matrix(0 900 900 0 0 0)"
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0%" stopColor="#3ddeed" />
          <stop offset="99.66%" stopColor="#cb00dd" />
